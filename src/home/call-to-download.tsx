...
import NewsletterSignup from '../components/ui/send-email';
...
export default function NewsletterSection() {
  ...
  return (
    <Suspense fallback="loading">
      <section className="w-screen pt-12 md:pt-24 lg:pt-32 pb-52 pl-8 pr-8 flex flex-col text-center space-y-4 ">
